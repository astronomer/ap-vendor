...
git_root = [x for x in Path(__file__).resolve().parents if (x / ".git").is_dir()][
    -1
]
...
if found_cves:
    print(f"New vulnerabilities found. Fix them or add them to {project_name}/twistcliignore\n")
